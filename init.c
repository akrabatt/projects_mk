...
//    PR6 = 62195;            // Установка значения предварительной загрузки для сравнения с таймером T6
    PR6 = 1000;            // Установка значения предварительной загрузки для сравнения с таймером T6
    ...
    T6CONbits.TCKPS = 0b10; // Установка предделителя таймера T6 на значение 1:8
...
void InitializeSystem(void)
{
    ...
    T6CONbits.ON = 1;  // Включение таймера 5
