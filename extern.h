...
extern "C" {
    ...
    extern unsigned int rpm_count;
    extern unsigned int total_err_count1;
    extern unsigned int total_err_count2;
    extern unsigned int delay_before_start;
    ...
    extern unsigned int CV_blok_regul;
